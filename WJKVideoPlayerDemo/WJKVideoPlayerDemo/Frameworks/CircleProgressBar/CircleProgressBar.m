...
- (void)setupHint
{
    UIView *hintView = [[UIView alloc] initWithFrame:CGRectMake(10 * WIDTHFIT, 10 * HEIGHTFIT, 70 * WIDTHFIT, 70 * WIDTHFIT)];
    [self addSubview:hintView];
    
    UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 70 * WIDTHFIT, 3 * HEIGHTFIT)];
    line.center = hintView.center;
    line.backgroundColor = [UIColor orangeColor];
    [self addSubview:line];
    
    self.hintLabelCountUp = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 70 * WIDTHFIT,  30 * HEIGHTFIT)];
    self.hintLabelCountUp.font = [UIFont systemFontOfSize:30];
    self.hintLabelCountUp.textColor = [UIColor orangeColor];
    self.hintLabelCountUp.textAlignment = 1;
    [hintView addSubview:self.hintLabelCountUp];
    
    self.hintLabelCountDown = [[UILabel alloc] initWithFrame:CGRectMake(0, 52 * HEIGHTFIT, 70 * WIDTHFIT,  12 * HEIGHTFIT)];
    self.hintLabelCountDown.font = [UIFont systemFontOfSize:12];
    self.hintLabelCountDown.textColor = [UIColor whiteColor];
    self.hintLabelCountDown.textAlignment = 1;
    [hintView addSubview:self.hintLabelCountDown];
}
...
- (void)setHintTextCountUp:(NSString *)hintTextCountUp
{
    _hintTextCountUp = hintTextCountUp;
    self.hintLabelCountUp.text = _hintTextCountUp;
}

- (void)setHintTextCountDown:(NSString *)hintTextCountDown
{
    _hintTextCountDown = hintTextCountDown;
    self.hintLabelCountDown.text = _hintTextCountDown;
}
