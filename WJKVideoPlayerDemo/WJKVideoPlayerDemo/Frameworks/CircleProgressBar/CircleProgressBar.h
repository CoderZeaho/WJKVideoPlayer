...
@property (nonatomic, copy) NSString *hintTextCountUp;
@property (nonatomic, copy) NSString *hintTextCountDown;
@property (nonatomic, strong) UILabel *hintLabelCountUp;
@property (nonatomic, strong) UILabel *hintLabelCountDown;
