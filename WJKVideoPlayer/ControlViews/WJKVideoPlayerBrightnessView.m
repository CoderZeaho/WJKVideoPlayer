...
@implementation WJKVideoPlayerBrightnessView

+ (instancetype)sharedBrightnessView {
	static WJKVideoPlayerBrightnessView *instance;
	static dispatch_once_t onceToken;
	dispatch_once(&onceToken, ^{
		instance = [[WJKVideoPlayerBrightnessView alloc] init];
...
- (void)setIsStatusBarHidden:(BOOL)isStatusBarHidden {
    ...
    [[UIViewController currentViewController] setNeedsStatusBarAppearanceUpdate];
}
