...
@class WJKVideoPlayerDownloader, WJKResourceLoadingRequestTask;
@class WJKResourceLoadingRequestWebTask;

@protocol WJKVideoPlayerDownloaderDelegate<NSObject>
...
@interface WJKVideoPlayerDownloader : NSObject
 ...
 */
@property (nonatomic, weak, readonly, nullable) WJKResourceLoadingRequestWebTask *runningTask;

/**
 * The current downloaderOptions, may nil if no download operation.
 */
@property (nonatomic, assign, readonly) WJKVideoPlayerDownloaderOptions downloaderOptions;

@property (nonatomic, weak) id<WJKVideoPlayerDownloaderDelegate> delegate;
