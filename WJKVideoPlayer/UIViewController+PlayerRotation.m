...
+ (void)load {
    ...
    for (NSUInteger index = 0; index < sizeof(selectors) / sizeof(SEL); ++index) {
        ...
        SEL swizzledSelector = NSSelectorFromString([@"wjk_" stringByAppendingString:NSStringFromSelector(originalSelector)]);
...
- (NSInteger)wjk_selectedIndex {
    NSInteger index = [self wjk_selectedIndex];
